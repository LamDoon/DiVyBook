                ...
                <body>
                    ...
                    <div>     
                        <form method="post" action="" class="clear" enctype="multipart/form-data" >
                            <input type="submit" value="Thêm Loại" name="them" id="themtg">
                        </form>
                    </div>                        
                        ...
                        while (($rows = mysqli_fetch_assoc($results)) != NULL) {
                            ...
                            <tr align="center">
                                ...
                                <td><?php echo $rows['TenLoai']; ?></td>
                                  <td>
                <a href="ql_loai_xoa.php?MaLoai=<?php echo $rows['MaLoai'];?>" onclick="return confirm('Ban co chac chan muon xoa khong?');">Xóa</a>
            </td>
                            </tr>
                            <?php
                        }
                    ...
                    if (isset($_POST['them'])) {
                        ?> 
                        <form action="ql_loai_them.php" method="post" enctype="multipart/form-data" name="form1">
                            <table class="tbthem" align="left"  width="1000">
                                <tr >
                                    <td class="titlethem" align="right">Mã Loai</td>
                                    <td class="txtthem"><input type="text" name="MaLoai" value="" /></td>
                                </tr>
                                <tr >
                                    <td class="titlethem" align="right">Tên Loai</td>
                                    <td class="txtthem"><input type="text" name="TenLoai" value="" /></td>
                                </tr>            
                                <td  align="right">
