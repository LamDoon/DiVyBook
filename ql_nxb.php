                ...
                <body>
                    ...
                    <div>     
                        <form method="post" action="" class="clear" enctype="multipart/form-data" >
                            <input type="submit" value="Thêm NXB" name="them" id="themtg">
                        </form>
                    </div>                        
                    ...
                    if (isset($_POST['them'])) {
                        ?> 
                        <form action="ql_nxb_them.php" method="post" enctype="multipart/form-data" name="form1">
                            <table class="tbthem" align="left"  width="1000">
                                <tr >
                                    <td class="titlethem" align="right">Mã NXB</td>
                                    <td class="txtthem"><input type="text" name="MaNXB" value="" /></td>
                                </tr>
                                <tr >
                                    <td class="titlethem" align="right">Tên NXB</td>
                                    <td class="txtthem"><input type="text" name="TenNXB" value="" /></td>
                                </tr>            
                                <td  align="right">
